...
- **奪う** 盤上で血が動くのは**強襲**だけ。通り抜けざまに相手を組み伏せ、**血の半分**を奪って足を止める。
  **仕留めはしない** ―― 狩り場は道中で、帰り道の待ち伏せがこの盤面の PVP
- **仕留め** 影渡りで相手をハンターに触れさせると、相手が抱えていた血の**半分**が自分のものになる（残りは村へ還る）。
  組み伏せようが仕留めようが、**動くのは常に半分**
- **先手** 夜ごとに1つずつ回る
...
| 強襲 | 3 | このターン、通り抜けたマスにいる相手を**組み伏せる**。抱えていた血の半分を奪い、その手番の足を止める |
...
代わりに、決まれば相手が抱えていた血の半分を奪い、その場に押さえて足を止められる。
**仕留めはしない** ―― 奪うのは積荷の半分と一手番ぶんの足だけで、盤上の位置は相手に残る。
