    ...
    panel.innerHTML = `
      ...
      <details class="rules">
        ...
        <ul>
          ...
          <li><b>吸血</b> 村でターンを終えるたびに <b>10 / 30 / 50 / 100</b> のどれかを吸える。いくつ出るかは振ってみるまで分からない。いくら抱えても足は鈍らない。</li>
          ...
          <li><b>避難所</b> テント4つ＋洞窟2つの計6マスだけ。<b>テントは定員1人</b>、<b>洞窟は同時に何人でも入れる</b>。リング2のテントはハンターの巡回路と重なっている。</li>
          <li><b>ハンター</b> 黄色い三角。リング2を1ラウンドに1マスずつ周回する。触れれば即死。位置も進路も読める。</li>
          <li><b>洞窟</b> 最外リングの左右2つだけ。通るとコウモリを<b>2枚</b>引ける。同じ洞窟は一夜に1回、1ターンに1つまで。日陰も兼ねる。</li>
